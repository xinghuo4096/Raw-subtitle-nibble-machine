...
def make_double_lanague_subtitle(media='movie 1',
                                 form_sub='indata/test_srt1.srt',
                                 form_language1: str = 'en',
                                 to_language='cn') -> str:
    '''
    _summary_

    Args:
        sub1 (str, optional): _description_. Defaults to 'indata/test_srt1.srt'.
        form_language1 (str, optional): _description_. Defaults to 'en'.
        to_language (str, optional): _description_. Defaults to 'cn'.
    ...
    movie1 = Media(media)
    movie1.add_subtitle(form_language1, form_sub)

    assert movie1.subtitles[0].language == form_language1
